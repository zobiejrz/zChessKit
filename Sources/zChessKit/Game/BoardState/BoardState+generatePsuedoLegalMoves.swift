//
//  BoardState+generateAllPseudoMoves.swift
//  zChessKit
//
//  Created by Ben Zobrist on 11/3/25.
//

import zBitboard

extension BoardState {
    // MARK: - generateAllPseudoMoves
    public func generateAllPseudoMoves(_ player: PlayerColor? = nil) -> [Move] {
